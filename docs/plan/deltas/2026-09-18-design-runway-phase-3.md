...
| MARXY-44 | Paths | `apps/desktop/src/trust, apps/desktop/src/notices, apps/desktop/src/commands/trust.ts, apps/desktop/src/commands/index.ts, apps/desktop/src/app.ts, fixtures/corpus/16-unclosed-script.md, packages/core/goldens, apps/desktop/test/trust.test.mjs` (the sanitiser path moves to MARXY-96) |
