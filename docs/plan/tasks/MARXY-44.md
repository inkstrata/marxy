---
key: MARXY-44
design: [12-trust, 09-app-shell, 11-config-and-storage, 08-position-and-watching]
...
**Design:** [12-trust](../../design/12-trust.md) §The unclosed-element case, §Persistence, §The notice, §Revoking · [09-app-shell](../../design/09-app-shell.md) §Notices · [11-config-and-storage](../../design/11-config-and-storage.md) §Data files · [08-position-and-watching](../../design/08-position-and-watching.md) (re-render keeps position) · **Depends on:** MARXY-96 (core), MARXY-26 (notices region and the blocked-content notice it starts), MARXY-42 (command registry), MARXY-38 (data-file storage helpers) · **ADRs:** ADR-0009, ADR-0027.
