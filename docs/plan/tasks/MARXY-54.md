...
**Design:** [13-release](../../design/13-release.md) §The v1 gate · **ADRs:** ADR-0014 (tier 2), ADR-0019 · **Depends on:** MARXY-51, MARXY-52, MARXY-53 · **Human-led:** the review and the tag are Ian's; an agent prepares everything and verifies the table.
