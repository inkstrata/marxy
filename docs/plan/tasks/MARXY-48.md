...
This story is the largest in Phase 3. Land it as one story. MARXY-191 removed the 600-line branch budget, so line count is not a split. The seam below (48a outline + find, 48b keyboard audit + external editor) is for a later planner if a reviewer returns the story. Do not split it in this PR.
