...
**Design:** none of its own; each item names the design it changes. [13-release](../../design/13-release.md) §The v1 gate is what this story must leave true · **Depends on:** MARXY-31, MARXY-39 (reviews #1 and #2 decided) · **ADRs:** ADR-0014, ADR-0016.
