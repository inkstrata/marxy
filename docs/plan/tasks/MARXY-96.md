...
**Design:** [13-trust](../../design/13-trust.md) §The wide policy, §Rules every policy now carries · [02-render](../../design/02-render.md) §Two-pass sanitise · **Depends on:** MARXY-75 (two-pass pipeline, `withProvenance`) · **ADRs:** ADR-0009, ADR-0023, ADR-0027.
