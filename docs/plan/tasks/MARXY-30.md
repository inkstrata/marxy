...
## Do this
1. Baselines for every corpus markdown file at 960 px, light and dark, first screen and last-heading screen, in Playwright WebKit (macOS runner) and Chromium (Linux runner) — committed under `fixtures/baselines/<engine>/` (PNG, `binary` attribute already set).
