...
| [0021](0021-parser-mdast-micromark.md) | The parser is mdast/micromark, not markdown-it | proposed until MARXY-11 |
| [0022](0022-perf-budgets-two-tier-enforcement.md) | Product budgets on reference hardware; CI enforces an envelope and a baseline | accepted, amended 2026-09-18 |
