...
| --- | --- | --- | --- | --- | --- |
| 2026-09-18 | MARXY-73 | The hostile fixture grew labelled attack-vector sections; after sanitise the new headings and leftover alt text are visible | `packages/core/goldens/10-hostile.ast.txt` (AST only; existing node ranges unchanged) | Do the added headings and leftover alt text read as a test document rather than leftover attack chrome? | pending |
