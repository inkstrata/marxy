...
| --- | --- | --- | --- | --- | --- |
| 2026-09-18 | handoff | Typeface pair for the default theme (review #0) | to be produced by MARXY-016 | Literata + JetBrains Mono, or Source Serif 4 + IBM Plex Mono? Live with each for a week on the long document. | pending |
