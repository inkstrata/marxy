...
lede: Accessibility in a reader is not a checklist appended at the end. It is most of what the reading settings are for. This chapter sets out the WCAG requirements that bind a reader's text, what the evidence says about contrast, polarity and dark mode, how to design themes that pass, and what readers with low vision and dyslexia actually need, which is often not what the market offers them.
description: Contrast, dark mode, themes, colour-vision deficiency, WCAG requirements, dyslexia and low vision.
when: you are designing themes or reviewing accessibility
icon: contrast
---
