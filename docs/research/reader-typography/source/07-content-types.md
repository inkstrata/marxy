...
slug: content-types
number: 7
title: Typography by Content Type
short: Content types
h1: Typography by Content Type
...
description: Fiction, non-fiction, documentation, poetry, drama, screenplays, math, tables, chat logs: what each asks of the page.
when: you need per-genre rules
icon: book
---
