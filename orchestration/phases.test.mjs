...
// There is no branch-size budget: a 600-line limit on the three-dot diff (MARXY-142) forced one
// change into several stacked PRs and a self-referential test that failed until the ones below it
// merged. Size is the reviewer's judgement of "one concern", not a number (MARXY-191).
// The same guard refused any branch that touched a 2026-09-18 plan delta; MARXY-107 discarded those
// files days ago, and a branch-scoped check of history is the kind this removal retires.
