...
- The orchestrator human queue lists only the three items still waiting on a person; twelve stale open bullets (merged PRs, already-recorded rulings) are gone so a cycle no longer reports them as open work (MARXY-179)
