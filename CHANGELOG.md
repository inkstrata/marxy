...
### Changed
- Cold start is no longer a 500 ms promise: every run still measures it and a silent record still fails, but a tag does not fail for being slower than 500 ms (MARXY-103)
