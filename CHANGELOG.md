...
### Added
- `jira.mjs task` creates an issue for work outside the plan, and the commit-msg hook now fails instead of skipping when commitlint is not installed (MARXY-101)
