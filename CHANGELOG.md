...
### Changed
- CI perf numbers are re-derived from five or more corrected cross-run jobs per runner class: Ubuntu keeps a 1030 ms warm baseline at 12 % tolerance and a 1343 ms cold envelope, and macOS waives the warm baseline at 1.542× cross-run spread while gating a 3397 ms cold ceiling (MARXY-70)
