...
| KaTeX math fonts | github.com/KaTeX/KaTeX (`katex` npm package) | SIL OFL 1.1 | `fonts/katex/*` (loaded when a document contains math) |

KaTeX library code is MIT (`node_modules/katex/LICENSE`). Its fonts are OFL and are copied unmodified from `katex/dist/fonts/`.
