...
## Rendered, hyphenation on (MARXY-24)

<!-- hyphenated-table:start (generated by packages/typeset/scripts/measure-rendered.mjs --hyphenate; do not edit by hand) -->

Rendered in Playwright WebKit (`"24.18.1"` Node), default theme, bundled Literata at 17 px, measure 671.2 px (68 ch), glue stretch 2 em, hyphenation on (en-us/en-gb). Widths are real line boxes, px; a line is short when its shortfall exceeds 10% of the measure. Last lines excluded.

| Document | Paras | Lines native → set | CV native | CV set | Short native | Short set |
| --- | --- | --- | --- | --- | --- | --- |
| `01-long-technical.md` | 50 | 151 → 150 | 0.0412 | 0.0369 | 12 (11.9%) | 6 (6.0%) |
| `02-readme-real-world.md` | 1 | 2 → 2 | 0.0000 | 0.0000 | 1 (100.0%) | 0 (0.0%) |
| `03-ai-plan.md` | 2 | 4 → 4 | 0.0201 | 0.0172 | 0 (0.0%) | 0 (0.0%) |
| `06-math.md` | 3 | 7 → 7 | 0.0097 | 0.0097 | 0 (0.0%) | 0 (0.0%) |
| `07-cjk.md` | 3 | 9 → 9 | 0.0170 | 0.0170 | 0 (0.0%) | 0 (0.0%) |
| `08-rtl.md` | 3 | 7 → 7 | 0.0177 | 0.0177 | 0 (0.0%) | 0 (0.0%) |
| `09-gfm-everything.md` | 1 | 5 → 5 | 0.3253 | 0.3253 | 2 (50.0%) | 2 (50.0%) |
| `10-hostile.md` | 4 | 8 → 8 | 0.0371 | 0.0333 | 0 (0.0%) | 0 (0.0%) |
| `14-marxy-plan.md` | 28 | 74 → 73 | 0.0435 | 0.0324 | 5 (10.9%) | 2 (4.4%) |
| `15-prose-volume.md` | 78 | 603 → 601 | 0.0301 | 0.0202 | 18 (3.4%) | 1 (0.2%) |
| `README.md` | 4 | 12 → 12 | 0.0354 | 0.0127 | 2 (25.0%) | 0 (0.0%) |
| **corpus** | **177** | **882 → 878** | **0.0420** | **0.0354** (-15.8%) | **40 (5.7%)** | **11 (1.6%)** |

Typesetter over the corpus: 287 candidates, 167 set, 102 already one line, 18 left to the engine (inline object 8, CJK 7, overflow after setting 3). Viewport pass: 01-long-technical 26 ms, 02-readme-real-world 13 ms, 03-ai-plan 14 ms, 06-math 0 ms, 07-cjk 0 ms, 08-rtl 34 ms, 09-gfm-everything 9 ms, 10-hostile 12 ms, 14-marxy-plan 40 ms, 15-prose-volume 53 ms, README 19 ms.

<!-- hyphenated-table:end -->

### What the hyphenated numbers say (MARXY-24)

The command is `node packages/typeset/scripts/measure-rendered.mjs --hyphenate --write`. Same page,
same measure, same breaker as the MARXY-23 "Rendered" table, with `justif/hyphenate/en-us` (and
`en-gb` when `lang` says so). Code, URLs and digit-words stay whole.

Compared with hyphenation off (the table above): short lines fall from 26 (3.7%) to 11 (1.6%), CV
from 0.0394 to 0.0354, and the line count drops by three. The story's rule was to ship hyphenation
on only if the short-line rate did not rise; it fell, so `hyphenate: true` is the default. On
continuous prose the hole almost disappears (18 native short lines → 1). Technical text also
improves (12 → 6) because a long word can now end a line instead of forcing the line before it
short. Viewport cost rises — 15-prose-volume 24 ms → 53 ms — and stays inside the 100 ms budget.
